import {
  PLACE_SIGN, CHANGE_GAME_MODE,
  UNDO, UNDO_AI, REDO, REDO_AI,
  PLACE_SIGN_AI
...
export const undoRedoAction = (actionType) =>
  (dispatch, getState) => {
  ...
  (dispatch, getState) => {
    ...
    if (shouldAiAct(newState)) {
      ...
      const aiTimeoutCb = () => {
        ...
        const pos = aiMove(
          getBoard(newState), getTurn(newState), symb.o, newState.gameMode
        );
