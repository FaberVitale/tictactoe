...
const aiProfiles = {
  [gameMode.PVAI_EASY]: logicRunner(
    turnZeroLogic.takeRandomCell,
    [
      takeIfEmpty.side,
      takeIfEmpty.center,
      takeIfEmpty.edge
    ]),
  [gameMode.PVAI_MEDIUM]: logicRunner(
    turnZeroLogic.takeCenterOrEdges,
    [
      lineLogic.twoInLine,
      takeIfEmpty.center,
      takeIfEmpty.edge,
  ...
  [gameMode.PVAI_UNFAIR]: logicRunner(
    turnZeroLogic.takeCenterOrEdges,
    [
      lineLogic.twoInLine,
      lineLogic.fork,
